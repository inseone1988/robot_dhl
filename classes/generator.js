...
class Generator {
    ...
    async finish() {
        let dirq1 = `INSERT INTO Direcciones_dhl(idasociado,nombre,compania,direccion,direccion1,ciudad,estado,cp,telefono,referencia1,referencia2,email,idtipoguia) VALUES (${this.data.client_id},'${this.data.shipper_nombre}','${this.data.shipper_compania}','${this.data.shipper_calle}','${this.data.shipper_colonia}','${this.data.shipper_ciudad}','${this.data.shipper_estado}','${this.data.shipper_cp}','${this.data.shipper_telefono}', '${this.data.shipper_calle2}', '${this.data.shipper_calle3}', '${this.data.shipper_email}','1') ON DUPLICATE KEY UPDATE compania = '${this.data.shipper_compania}', direccion = '${this.data.shipper_calle}', direccion1 = '${this.data.shipper_calle2}', ciudad = '${this.data.shipper_ciudad}', estado = '${this.data.shipper_estado}', cp = '${this.data.shipper_cp}', telefono = '${this.data.shipper_telefono}', referencia1 = '${this.data.shipper_calle2}', referencia2 = '${this.data.shipper_calle3}', email = '${this.data.shipper_email}', idtipoguia = '1'`;
